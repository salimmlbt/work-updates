...
interface DashboardClientProps {
  ...
  attendanceChartData: { name: string; hours: number }[]; // monthly data
...
export default function DashboardClient({
  ...
  return (
    <>
      {/* Full-screen loading overlay when navigating to Tasks */}
      {isTasksLoading && (
      ...
      <div className="p-4 md:p-8 lg:p-10 min-h-screen bg-gradient-to-br from-slate-50 via-slate-50 to-sky-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Stat Cards (ONLY clickable cards) */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <button
                ...
                className="text-left"
              >
                <Card className="shadow-[0_12px_35px_rgba(15,23,42,0.08)] rounded-2xl bg-gradient-to-br from-sky-50 via-sky-100 to-sky-200 border border-sky-100/70 hover:-translate-y-1 transition-transform duration-300 cursor-pointer">
              ...
              <button
                ...
                className="text-left"
              >
                <Card className="shadow-[0_12px_35px_rgba(76,29,149,0.08)] rounded-2xl bg-gradient-to-br from-violet-50 via-violet-100 to-violet-200 border border-violet-100/70 hover:-translate-y-1 transition-transform duration-300 cursor-pointer">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              ...
              <button
                ...
                className="text-left"
              >
                <Card className="shadow-[0_12px_35px_rgba(22,163,74,0.08)] rounded-2xl bg-gradient-to-br from-emerald-50 via-emerald-100 to-emerald-200 border border-emerald-100/70 hover:-translate-y-1 transition-transform duration-300 cursor-pointer">
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            {/* Attendance Chart – MONTHLY (no tooltip) */}
            ...
            {/* Assigned Projects (non-clickable card) */}
            <Card className="shadow-lg shadow-slate-200/70 rounded-2xl border border-slate-100 bg-white/90 backdrop-blur-sm">
              <CardHeader className="flex flex-row items-center justify-between">
                <div>
                  <CardTitle className="flex items-center gap-2 text-slate-900">
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Upcoming Deadlines (non-clickable card) */}
            <Card className="shadow-lg shadow-slate-200/70 rounded-2xl border border-slate-100 bg-white/90 backdrop-blur-sm">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-slate-900">
                              ...
                              <>
                                ...
                                <span
                                  className={cn(
                                    ...
                                    task.isOverdue ? 'text-red-900' : 'text-slate-900'
                                  )}
                                >
            ...
            {/* Monthly Attendance Summary (non-clickable card) */}
            <Card className="shadow-lg shadow-slate-200/70 rounded-2xl border border-slate-100 bg-white/90 backdrop-blur-sm">
