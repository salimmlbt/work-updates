  ...
  return (
    <div className="relative min-h-screen bg-[#05050a] text-zinc-100 p-4 md:p-8 lg:p-10 overflow-hidden">
          ...
          >
            <div className="flex flex-col items-center gap-8">
              ...
              <div className="flex items-center gap-1">
                <span className="text-xs text-slate-300 font-bold tracking-[0.4em] uppercase">Syncing Statements</span>
              </div>
            </div>
          </motion.div>
        )}
      ...
      <header className="relative z-10 mb-12 flex flex-col md:flex-row md:items-center justify-between gap-8">
        <div>
          <h1 className="text-3xl font-black tracking-tighter text-white uppercase drop-shadow-[0_0_15px_rgba(255,255,255,0.1)]">
            Attendance Center
          </h1>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="hidden lg:flex items-center gap-3 px-5 py-2.5 rounded-2xl bg-white/[0.03] border border-white/10 text-xs font-bold uppercase tracking-widest text-zinc-400 backdrop-blur-md">
      ...
      <div className="relative z-10 grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <GlassCard gradientFrom="rgba(16, 185, 129, 0.12)">
          <div className="p-8">
            ...
            <p className="text-4xl font-black text-white tracking-tighter drop-shadow-lg">{stats.present}</p>
        ...
        <GlassCard gradientFrom="rgba(56, 189, 248, 0.12)">
          <div className="p-8">
            ...
            <p className="text-4xl font-black text-white tracking-tighter drop-shadow-lg">{stats.completed}</p>
        ...
        <GlassCard gradientFrom="rgba(244, 63, 94, 0.12)">
          <div className="p-8">
            ...
            <p className="text-4xl font-black text-white tracking-tighter drop-shadow-lg">{stats.absent}</p>
