...
export default async function TeamsPage() {
  ...
  const permissionsList = [
    ...
    { id: 'scheduler', label: 'Can the "{ROLE_NAME}" Access Scheduler?' },
    { id: 'report', label: 'Can the "{ROLE_NAME}" Access Report?' },
    { id: 'falaq_corner', label: 'Can the "{ROLE_NAME}" Access Falaq Corner?' },
    { id: 'chat', label: 'Can the "{ROLE_NAME}" Access Chat?' },
    { id: 'attendance', label: 'Can the "{ROLE_NAME}" Access Attendance?' },
